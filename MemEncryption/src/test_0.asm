...
_test_0:     file format elf32-i386
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d9:	0f b6 91 64 0a 00 00 	movzbl 0xa64(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 517:	75 25                	jne    53e <printf+0x103>
          s = "(null)";
 519:	c7 45 f4 19 08 00 00 	movl   $0x819,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e4:	a1 80 0a 00 00       	mov    0xa80,%eax
 ...
 6af:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 6b4:	90                   	nop
 6b5:	c9                   	leave  
 6b6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 711:	83 c4 10             	add    $0x10,%esp
  return freep;
 714:	a1 80 0a 00 00       	mov    0xa80,%eax
}
 719:	c9                   	leave  
 71a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 731:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 734:	a1 80 0a 00 00       	mov    0xa80,%eax
 739:	89 45 f0             	mov    %eax,-0x10(%ebp)
 73c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 740:	75 23                	jne    765 <malloc+0x4a>
    base.s.ptr = freep = prevp = &base;
 742:	c7 45 f0 78 0a 00 00 	movl   $0xa78,-0x10(%ebp)
 749:	8b 45 f0             	mov    -0x10(%ebp),%eax
 74c:	a3 80 0a 00 00       	mov    %eax,0xa80
 751:	a1 80 0a 00 00       	mov    0xa80,%eax
 756:	a3 78 0a 00 00       	mov    %eax,0xa78
    base.s.size = 0;
 75b:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 762:	00 00 00 
  }
 ...
 7b8:	a3 80 0a 00 00       	mov    %eax,0xa80
      return (void*)(p + 1);
 ...
 7c3:	eb 3b                	jmp    800 <malloc+0xe5>
    ...
    if(p == freep)
 7c5:	a1 80 0a 00 00       	mov    0xa80,%eax
